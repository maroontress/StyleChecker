...
/// <summary>
/// Extracts <c>Belief</c>s embedded in a C# source code.
/// </summary>
...
public sealed class BeliefExtractor : DiagnosticAnalyzer
{
    ...
    /// </summary>
    public const string DiagnosticId = "BeliefExtractor";
    ...
    private void AnalyzeSyntaxTree(SyntaxTreeAnalysisContext context)
    {
        ...
        foreach (var (trivia, comment, line) in ConcatLines())
        {
            ...
            var hatsFollowedByBody = comment.Substring(bodyOffset + 1);
            var hatDelta = GetCount(hatsFollowedByBody, '^');
            var body = hatsFollowedByBody.Substring(hatDelta);
